...
function adjustWebcamSize() {
    ...
    var containerHeight = containerWidth * 0.75; // Asumsikan rasio 4:3 untuk webcam
...
window.addEventListener('load', adjustWebcamSize);
    ...
    $("#absen").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (respond) {
                console.log('Respond:', respond); // Tambahkan ini untuk debugging
