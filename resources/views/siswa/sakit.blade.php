                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <div class="form-group">
                                        <h5>Tata Cara Mengisi Form Sakit</h5>
                                        <ol class="list-group list-group-numbered">
                                            <!-- Step 1 -->
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="ms-2 me-auto">
                                                    <div class="fw-bold">Langkah 1</div>
                                                    Pilih file foto bukti sakit, seperti surat dokter atau foto kondisi.
                                                </div>
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="ms-2 me-auto">
                                                    ...
                                                    Isi keterangan kondisi sakit yang dialami secara jelas dan singkat.
                                                </div>
                                            ...
                                            <li class="list-group-item d-flex justify-content-between align-items-start">
                                                <div class="ms-2 me-auto">
                                                    ...
                                                    Klik tombol "Kirim" untuk menyelesaikan pengisian form sakit.
                                                </div>
