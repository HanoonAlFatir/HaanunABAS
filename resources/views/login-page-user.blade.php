...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="{{ asset('assets/siswa/img/LogoAbas.png') }}" alt="image" class="form-image">
            </div>
            <div class="section mt-1">
                <h1>Selamat Datang di ABAS!</h1>
                <h4>isi form dibawah untuk melanjutkan</h4>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="text" class="form-control" id="email" name="identifier" placeholder="Username" required>
                            <i class="clear-input">
